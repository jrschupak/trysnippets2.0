      ...
      <DocumentTitle title="Home">
        ...
        <div className="row buttons" style={row}>
          <div className="col-sm-10 col-sm-offset-1 text-center">
            <Link to="/snippet5"><button id="btnClear" className="btn btn-warning btn-md center-block" style={btn}  value={1}>Input pop-up container <br /> HTML, JS, CSS </button></Link>
            ...
            <Link to="/snippet4"><button id="btnClear" className="btn btn-info btn-md center-block" style={btn}  value={1}>JavaScript <br /> Math.random function </button></Link>
